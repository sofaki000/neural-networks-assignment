...
def train_and_evaluate_model(model, file_name, lr=0.001, best_model_name="best_model"):
...
file_name = 'results/early_stopping'
train_and_evaluate_model(model, file_name, best_model_name="best_model_early_stop")
...
train_and_evaluate_model(model, file_name,lr=0.01, best_model_name="best_model_batch_norm_small_lr")
...
train_and_evaluate_model(model, file_name, best_model_name="best_model_batch_norm")
...
train_and_evaluate_model(model, file_name, best_model_name="best_model_l1_regul")
...
train_and_evaluate_model(model, file_name, best_model_name="best_model_dropout")
...
train_and_evaluate_model(model, file_name, best_model_name="best_model_weight_decay")
...
train_and_evaluate_model(model, file_name, best_model_name="best_model_weight_decay_initialzied_weights")